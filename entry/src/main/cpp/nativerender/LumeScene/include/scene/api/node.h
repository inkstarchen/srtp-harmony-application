...
// #include <scene/interface/intf_text.h>  // Temporarily disabled
...
// /// Wrapper for Scene text nodes which implement SCENE_NS::IText.  // Temporarily disabled
// class Text3D : public Node {  // Temporarily disabled
// public:  // Temporarily disabled
//     META_INTERFACE_OBJECT(Text3D, Node, IText)  // Temporarily disabled
//     /// @see IText::Test  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(BASE_NS::string, Text)  // Temporarily disabled
//     /// @see IText::FontFamily  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(BASE_NS::string, FontFamily)  // Temporarily disabled
//     /// @see IText::FontStyle  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(BASE_NS::string, FontStyle)  // Temporarily disabled
//     /// @see IText::FontSize  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(float, FontSize)  // Temporarily disabled
//     /// @see IText::Font3DThickness  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(float, Font3DThickness)  // Temporarily disabled
//     /// @see IText::FontMethod  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(SCENE_NS::FontMethod, FontMethod)  // Temporarily disabled
//     /// @see IText::TextColor  // Temporarily disabled
//     META_INTERFACE_OBJECT_PROPERTY(BASE_NS::Math::Vec4, TextColor)  // Temporarily disabled
//     /// Set TextColor from BASE_NS::Color.  // Temporarily disabled
//     auto& SetTextColor(const BASE_NS::Color& color)  // Temporarily disabled
//     {  // Temporarily disabled
//         SetTextColor(BASE_NS::Math::Vec4(color.r, color.g, color.b, color.a));  // Temporarily disabled
//         return *this;  // Temporarily disabled
//     }  // Temporarily disabled
// };  // Temporarily disabled
