...
public:
    ...
    // /// Creates a new text node with given parameters.  // Temporarily disabled
    // META_API_ASYNC auto CreateTextNode(const TextResourceParameters& params)  // Temporarily disabled
    // {  // Temporarily disabled
    //     return CallCreateNode<Text3D, CallType>(params, ClassId::TextNode);  // Temporarily disabled
    // }  // Temporarily disabled
