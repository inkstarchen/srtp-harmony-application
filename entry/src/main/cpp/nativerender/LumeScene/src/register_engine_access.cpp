...
// #include <text_3d/ecs/components/text_component.h>  // Temporarily disabled
...
// using TEXT3D_NS::TextComponent;  // Temporarily disabled
...
// DECLARE_PROPERTY_TYPE(TextComponent::FontMethod);  // Temporarily disabled
CORE_END_NAMESPACE()
...
// META_TYPE(TEXT3D_NS::TextComponent::FontMethod);  // Temporarily disabled
...
void RegisterEngineAccess()
{
    ...
    // RegisterMapEngineAccessImpl<TextComponent::FontMethod, SCENE_NS::FontMethod>();  // Temporarily disabled
...
void UnregisterEngineAccess()
{
    ...
    // r.GetEngineData().UnregisterInternalValueAccess(META_NS::MetaType<TextComponent::FontMethod>::coreType);  // Temporarily disabled
}
