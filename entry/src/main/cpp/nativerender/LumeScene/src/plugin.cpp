...
// #include "component/text_component.h"  // Temporarily disabled
...
#include "node/node.h"
// #include "node/text_node.h"  // Temporarily disabled
...
static PluginToken RegisterInterfaces(IPluginRegister& pluginRegistry)
{
    ...
    // META_NS::RegisterObjectType<TextNode>();  // Temporarily disabled
    ...
    // META_NS::RegisterObjectType<TextComponent>();  // Temporarily disabled
...
static void UnregisterInterfaces(PluginToken)
{
    ...
    // META_NS::UnregisterObjectType<TextNode>();  // Temporarily disabled
    ...
    // META_NS::UnregisterObjectType<TextComponent>();  // Temporarily disabled
