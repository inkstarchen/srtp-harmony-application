...
class Bind : public IntroduceInterfaces<BaseObject, IValue, IBind, INotifyOnChange, ISerializable, IImportFinalize> {
    META_OBJECT(Bind, META_NS::ClassId::Bind, IntroduceInterfaces)
