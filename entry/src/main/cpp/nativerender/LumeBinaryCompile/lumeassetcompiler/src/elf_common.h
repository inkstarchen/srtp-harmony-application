...
#define STB_GLOBAL 1
#define STT_OBJECT 1
#define STV_DEFAULT 0  /* Default visibility - symbols can be referenced by other modules */
#define STV_HIDDEN 2   /* Hidden visibility - symbols not visible outside the defining module */
